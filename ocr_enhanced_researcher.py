"""
ocr_enhanced_researcher.py
Patched: desktop switching aligned with integrated_navigator
"""
...
class OCREnhancedResearcher:
    ...
    async def open_url(self, url):
        ...
        # Switch back to Claude desktop (1)
    ...
    async def click_article_ocr(self, query):
        ...
        async with async_playwright() as p:
            ...
            page_path = "logs/debug_screenshots/page_for_ocr.png"
    ...
    async def run_cycle(self):
        ...
        # Always send screenshot + follow-up while on Claude desktop (1)
...
async def main():
    print("=== OCR Enhanced Researcher (patched) ===")

    # Start: move from Terminal (desktop0) → Claude (desktop1)
    KaiDesktopAgent(direction="right", presses=1).run_fast()
    time.sleep(1.0)

    researcher = OCREnhancedResearcher()
