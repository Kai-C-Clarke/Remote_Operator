...
class KaiWebAgent:
    """Fixed version that uses clipboard paste instead of URL parameter"""
    def __init__(self):
        self.logger = logger
    ...
    def run(self):
        self.log("Navigating using URL from clipboard")
        ...
        try:
            ...
            self.log("Successfully navigated using clipboard URL")
            return True
            
        except Exception as e:
            self.log(f"Failed to navigate: {e}")
            return False
                    ...
                    try:
                        ...
                        for i, text in enumerate(data['text']):
                            if text and ('http' in text.lower() or 'bbc' in text.lower() or 'www' in text.lower()):
                                ...
                                time.sleep(0.2)
                                pyautogui.drag(end_x - start_x, 0, duration=0.5)  # Drag horizontally
                                time.sleep(0.3)
